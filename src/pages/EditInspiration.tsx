    ...
    <main className="min-h-screen flex flex-col items-center justify-center p-6 bg-gradient-to-br from-bg-start via-bg-mid to-bg-end font-sans relative overflow-hidden">
      ...
      <div className="relative max-w-sm w-full bg-surface rounded-3xl border border-surface-dark/40 p-8 md:p-10 shadow-2xl shadow-border-main/10 flex flex-col z-10 min-h-[500px]">
        ...
        <div className="flex items-center justify-between mb-6">
          <Link to="/library/inspiration" className="text-primary/60 hover:text-primary transition-colors">
        ...
        {loading ? (
          ...
          <div className="flex-1 flex flex-col justify-center items-center">
            ...
            <Link to="/library/inspiration" className="bg-primary hover:bg-primary-strong text-on-primary py-2 px-4 rounded-xl text-xs">
          ...
          <div className="flex-1 flex flex-col justify-between text-left">
            <form onSubmit={handleSubmit} className="flex flex-col gap-4 max-h-[380px] overflow-y-auto pr-1 scrollbar-thin my-1">
              ...
              {/* Text */}
              <div>
                <label className="block text-[9px] uppercase tracking-wider text-text-muted/60 font-bold mb-1 ml-1">Quote Text</label>
                <textarea
                  value={text}
                  onChange={(e) => setText(e.target.value)}
                  className="w-full bg-surface-dark/25 border border-border-main/10 rounded-2xl py-2 px-3 text-text-main font-sans text-xs focus:outline-none focus:border-border-main/40 placeholder-plum-light/35 h-20 resize-none"
              ...
              {/* Author */}
              <div>
                <label className="block text-[9px] uppercase tracking-wider text-text-muted/60 font-bold mb-1 ml-1">Author (Optional)</label>
                <input
                  type="text"
                  value={author}
              ...
              {/* Source */}
              <div>
                <label className="block text-[9px] uppercase tracking-wider text-text-muted/60 font-bold mb-1 ml-1">Source (Optional)</label>
                <input
                  type="text"
                  value={source}
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="block text-[9px] uppercase tracking-wider text-text-muted/60 font-bold mb-1 ml-1">Theme Type</label>
                  <select
                    value={type}
                ...
                <div>
                  <label className="block text-[9px] uppercase tracking-wider text-text-muted/60 font-bold mb-1 ml-1">Tone</label>
                  <select
                    value={tone}
              ...
              <div className="flex flex-col gap-2 mt-4 pt-4 border-t border-border-main/10">
                ...
                <button
                  ...
                  disabled={submitting || !isEditable}
                  className="w-full border border-red-500/20 hover:border-red-500/40 text-red-600 py-2.5 rounded-2xl font-medium text-xs tracking-wide transition-all text-center bg-surface cursor-pointer"
                >
                  Delete Quote
                </button>
              </div>
