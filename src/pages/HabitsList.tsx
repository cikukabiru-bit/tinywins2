            ...
            <div>
              ...
              {habits.length === 0 ? (
                ...
                <div className="flex flex-col gap-5 max-h-[340px] overflow-y-auto pr-1 text-left scrollbar-thin my-2">
                  {goalAreas.map((area) => (
                    <div key={area} className="flex flex-col gap-3 p-4 rounded-2xl border border-border-main/10 bg-surface-dark/5">
                      {/* Goal Heading */}
                      ...
                      <div className="flex flex-col gap-3">
                        {groupedHabits[area].map((habit) => {
                          ...
                          return (
                            <div 
                              key={habit.id} 
                              className="bg-surface border border-border-main/15 rounded-xl p-3.5 flex flex-col transition-all hover:border-border-main/30 gap-3 shadow-sm"
                            >
                              <div>
